...
def find_minute_count_list(guard):
    ...
    return sleep_minute_count

def find_most_frequently_sleeping_guard(guards):
    max_count = 0
    max_minute = 0
    max_minute_guard = None
    for guard in guards:
        guard_minute_count_list = find_minute_count_list(guard)
        guard_max_minute = find_index_max_count(guard_minute_count_list)
        guard_max_minute_count = guard_minute_count_list[guard_max_minute]
        if max_count < guard_max_minute_count:
            max_count = guard_max_minute_count
            max_minute = guard_max_minute
            max_minute_guard = guard
    return (max_minute_guard, max_minute)
...
def main():
    ...
    (guard, minute) = find_most_frequently_sleeping_guard(guards)
